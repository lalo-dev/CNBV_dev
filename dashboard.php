...
<!--[if gt IE 9]><!--> <html class="no-focus"> <!--<![endif]-->
    ...
    <body>
        ...
        <div id="page-container" class="sidebar-l sidebar-o side-scroll header-navbar-fixed">
            <!-- Side Overlay-->
            <?php include_once('includes/zlib/sideContent.php'); ?>
            <!-- END Side Overlay -->

            <!-- Sidebar -->
            <?php include_once('includes/zlib/menu.php'); ?>
            <!-- END Sidebar -->

            <!-- Header -->
            <header id="header-navbar" class="content-mini content-mini-full">
                <!-- Header Navigation Right -->
                <?php include_once('includes/zlib/headerNavigation.php'); ?>
            ...
            <main id="main-container">
                <!-- Page Header -->
                <?php include_once('includes/zlib/pageHeader.php'); ?>
                <!-- END Page Header -->

                <!-- Stats -->
                <?php include_once('includes/zlib/stats.php'); ?>
                <!-- END Stats -->
...
//                                                 }
                                                ...
                                                <p class="font-s13"><a href="javascript:void(0)">Leer m�s >></a></p>
                                            </div>
                                        </li>
<?php
//                                     }
...
<!--                                         </li> -->
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="content-grid">
                                <div class="row">
                                    <div class="col-xs-12">
                                        <!-- Mini Stats -->
                                        <?php include_once('includes/zlib/miniStats.php'); ?>
                                        <!-- END Mini Stats -->
                                    </div>
                                </div>
                            </div>
            ...
            <!-- Footer -->
            <?php include_once('includes/zlib/footer.php'); ?>
            <!-- END Footer -->
        </div>
        <!-- END Page Container -->
