...
<div class="side-header side-content bg-white-op">
	...
	<a class="h5 text-white" href="index">
						...
						<li>
                            ...
                            <li class="mp1">
                                <a class="nav-submenu" data-toggle="nav-submenu" href="#">
                                    <i class="si si-layers"></i><span class="sidebar-mini-hide">Planeación anual</span>
                                </a>
                                <ul>
                                    <li>
                            ...
                            <li class="mp2">
                                <a class="nav-submenu" data-toggle="nav-submenu" href="#">
                                    <i class="si si-layers"></i><span class="sidebar-mini-hide">Auditoría</span>
                                </a>
                                <ul>
                                    <li>
                            ...
                            <li class="mp3">
                                <a class="nav-submenu" data-toggle="nav-submenu" href="#">
                                    <i class="si si-layers"></i><span class="sidebar-mini-hide">Seguimiento</span>
                                </a>
                                <ul>
                                    <li>
                            ...
                            <li class="mp4">
                                <a class="nav-submenu" data-toggle="nav-submenu" href="#">
                                    <i class="si si-layers"></i><span class="sidebar-mini-hide">PRAS</span>
                                </a>
                                <ul>
                                    <li>
                            ...
                            <li class="mp5">
                                <a class="nav-submenu" data-toggle="nav-submenu" href="#">
                                    <i class="si si-bar-chart"></i><span class="sidebar-mini-hide">Reportes</span>
                                </a>
                                <ul>
                                    <li>
                            ...
                            <li class="mp6">
                                <a class="nav-submenu" data-toggle="nav-submenu" href="#">
                                    <i class="si si-bar-chart"></i><span class="sidebar-mini-hide">Estadísticas</span>
                                </a>
                                <ul>
                                    <li>
                            ...
                            <li class="mp7">
                                <a class="nav-submenu" data-toggle="nav-submenu" href="#">
                                    <i class="si si-calendar"></i><span class="sidebar-mini-hide">Actividades</span>
                                </a>
                                <ul>
                                    <li>
                            ...
                            <li class="mp8">
                                <a class="nav-submenu" data-toggle="nav-submenu" href="#">
                                    <i class="si si-docs"></i><span class="sidebar-mini-hide">Normativa</span>
                                </a>
                                <ul>
                                    <li>
                            ...
                            <li class="mp9">
                                <a class="nav-submenu" data-toggle="nav-submenu" href="#">
                                    <i class="si si-docs"></i><span class="sidebar-mini-hide">Otras actividades</span>
                                </a>
                                <ul>
                                    <li>
